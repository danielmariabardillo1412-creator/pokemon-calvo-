...
Los ADR 001–033 están en [`adr/`](adr/). Se conservan porque documentan decisiones técnicas y límites que siguen siendo relevantes para evitar regresiones conceptuales.
