...
func _run() -> void:
	...
	DataFoundationV3AbilityClosureTestSuite.new().run(Callable(self, "_check"))
	...
	DataFoundationV3AbilityEndTurnOpponentTestSuite.new().run(Callable(self, "_check"))
	DataFoundationV3AbilityTargetStateTestSuite.new().run(Callable(self, "_check"))
	...
	DataFoundationV3ItemClosureTestSuite.new().run(Callable(self, "_check"))
	DataFoundationV3EvolutionClosureTestSuite.new().run(Callable(self, "_check"))
	DataFoundationV3EndToEndClosureTestSuite.new().run(Callable(self, "_check"))
